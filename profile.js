...
const resultsListing = document.getElementById("postContainer");
                        ...
                        <a href="/pages/specific-item/?id="${auction.id}">
                            <div class="card mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex">
                                        <img src="${profileImg}" class="" height="120" width="120" alt="Avatar" loading="lazy" />
...
const listingContent = document.getElementById("listingCoverage");
